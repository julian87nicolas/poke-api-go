...
var (
	...
	ErrPokeApiFailure  = errors.New("unexpected response on poke api")
)
...
func GetPokemon(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		respondwithJSON(w, http.StatusInternalServerError, fmt.Sprintf("error while calling poke api: %s", err))
	}
